...
export const createBicycleNowAction = (bicycle) => {
    ...
    return async (dispatch) => {
        ...
        try {
            ...
            dispatch({ type: bicycleConstants.BICYCLE_CREATE_REQUEST });

            // here we are going to make API CALLS 
            const res = await axios.post('/createBicycle', {
                ...bicycle
            });
            // path , payload 
            ...
            if (res.status === 200) {
                ...
                dispatch({
                    type: bicycleConstants.BICYCLE_CREATE_SUCCESS,
                    payload: {
                        // token,
                        // user 
                        message
                ...
                dispatch({
                    type: bicycleConstants.BICYCLE_CREATE_FAILURE,
